...
#     print('Panir World! inside the function')
#
# # call the function
# greet()
# #
...
# def my_function(fname,lname="Patil"):
#   print(fname," ", lname)
#
# my_function("Mahesh")
...
#
# # Driver code (We call myFun() with only 1
# # argument)
#
# myFun(10) #  x positiopnal=10 and y Default =50
# myFun(25)
# myFun(50)
# myFun(100)
# myFun(10,20)  # both Positional x=10 and y=20
...
#     print("y: ", y)
#
# # # Driver code (We call myFun() with a and 2
# # # argument)
# myFun(10)
# myFun(10,20)
# myFun(100,200)
...
# a=10
# print(type(a)) # same logic for print(add(20,10))
...
# result= add(100,50) #return value ko print krneke liye  result name se variable banaya
# print(result)
...
# b=20 # Global Varibale
# print(a+b)
#
# def add_numbers(c,d):
#     a=50 # Local Variables
